...
class Curb {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('points')) {
        ...
        this.points = new Array(100).fill(new PointStamped());
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.points.length !== 100) {
      throw new Error('Unable to serialize array field points - length must be 100')
    }
  ...
  static Resolve(msg) {
    ...
    if (msg.points !== undefined) {
      ...
      resolved.points = new Array(100).fill(new PointStamped())
    }
